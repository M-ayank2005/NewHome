...
const ar_SA = {
    ...
    updateFirefoxHomepageInfo:
        'لتغيير صفحتك الرئيسية لتكون مثل علامة تبويب جديدة، قم بزيارة <a href="https://github.com/M-ayank2005/NewHome#-firefox" target="_blank">هذا الرابط</a> واتبع التعليمات.',
    ...
    ProxyDisclaimer:
        "جميع ميزات الوكيل متوقفة عن التشغيل افتراضياً.\n\nإذا قمت بتمكين اقتراحات البحث ووكيل تجاوز CORS، فمن المستحسن بشدة استضافة وكيلك الخاص لزيادة الخصوصية.\n\nبشكل افتراضي، يتم تعيين الوكيل على https://newhome-proxy.rhythmcorehq.com، مما يعني أن جميع بياناتك ستمر عبر هذه الخدمة، مما قد يثير مخاوف تتعلق بالخصوصية.",
    GPSDisclaimer:
