...
const zh_TW = {
    ...
    "updateFirefoxHomepageInfo": "若要將首頁更改為與新分頁相同，請造訪 <a href=\"https://github.com/M-ayank2005/NewHome#-firefox\" target=\"_blank\">此連結</a> 並按照指示操作。",
    ...
    "ProxyDisclaimer": "所有代理功能預設為關閉。\n\n如果啟用搜尋建議和 CORS 繞過代理，強烈建議自行代管代理伺服器以提升隱私。\n\n預設情況下，代理會設定為 https://newhome-proxy.rhythmcorehq.com，這表示您的所有資料都會通過此服務，可能會出現隱私疑慮。",
