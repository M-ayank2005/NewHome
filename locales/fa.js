...
const fa = {
    ...
    updateFirefoxHomepageInfo:
        'برای تغییر صفحه اصلی خود مانند برگه جدید، از <a href="https://github.com/M-ayank2005/NewHome#-firefox" target="_blank">این پیوند</a> بازدید کرده و دستورالعمل‌ها را دنبال کنید.',
    ...
    ProxyDisclaimer:
        "تمام ویژگی‌های پروکسی به طور پیش‌فرض خاموش هستند.\n\nاگر پیشنهادات جستجو و پروکسی دور زدن CORS را فعال کنید، به شدت توصیه می‌شود برای افزایش حریم خصوصی، پروکسی شخصی خود را میزبانی کنید.\n\nبه طور پیش‌فرض، پروکسی روی https://newhome-proxy.rhythmcorehq.com تنظیم می‌شود، به این معنی که تمام داده‌های شما از طریق این سرویس عبور می‌کند، که ممکن است نگرانی‌های مربوط به حریم خصوصی را ایجاد کند.",
    GPSDisclaimer:
