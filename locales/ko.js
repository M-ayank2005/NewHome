...
const ko = {
    ...
    "updateFirefoxHomepageInfo": "새 탭과 함께 홈페이지도 바꾸려면 <a href=\"https://github.com/M-ayank2005/NewHome#-firefox\" target=\"_blank\">이 링크</a>를 확인하세요.",
    ...
    "ProxyDisclaimer": "모든 프록시 기능은 기본적으로 꺼져 있어요.\n\n검색 제안과 CORS 우회 프록시를 켜려면, 개인정보 보호를 위해 직접 프록시를 호스팅하는 걸 강력히 권장해요.\n\n기본 설정으로는 https://newhome-proxy.rhythmcorehq.com 프록시를 사용하는데, 이 경우 모든 데이터가 이 서비스를 거치게 돼서 개인정보 문제가 생길 수 있어요.",
